...
//   // Gestion du filtre cibleAudience
//   if (query.cibleAudience) {
...
//       { description: { contains: s } },
//       { nomAnnonceurExterne: { contains: s } },
//       { annonceurUtilisateur: { firstName: { contains: s } } },
//       { annonceurUtilisateur: { lastName: { contains: s } } },
//       { televersePar: { firstName: { contains: s } } },
//       { televersePar: { lastName: { contains: s } } },
//     ];
//   }

//   // Exécutez les deux requêtes en parallèle avec les mêmes filtres
