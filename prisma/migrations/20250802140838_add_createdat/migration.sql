/*
  ...
  - Added the required column `updatedAt` to the `Abonnement` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `updatedAt` to the `Ordonance` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `updatedAt` to the `SoldeMedecin` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE `Abonnement` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
-- AlterTable
ALTER TABLE `Ordonance` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL;

-- AlterTable
ALTER TABLE `Planning` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL;
...
-- AlterTable
ALTER TABLE `SoldeMedecin` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL;

-- AlterTable
ALTER TABLE `Speciality` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL;
