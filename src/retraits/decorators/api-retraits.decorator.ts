...
// 6. DEMANDER RETRAIT - sans nomRetraitSnapshot
export function ApiDemanderRetrait() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        "Permet à un médecin ou un hôpital de faire une demande de retrait de ses gains.",
    }),
    ApiBody({
      schema: {
        example: {
